...
doc = """The English version of Public Goods Game with endogeneous threshold
"""


class Constants(BaseConstants):
    name_in_url = 'PGGendoEN'
    players_per_group = 4
    num_rounds = 12
...
class Group(BaseGroup):
    ...
    def set_distribution_rule(self):
        if self.round_number in Constants.phase1:
            ...
            if self.in_round(self.round_number - 1).distribution_rule ==\
                    'Equal share of the bonus exception':
                self.distribution_rule = 'Equal payoff'
